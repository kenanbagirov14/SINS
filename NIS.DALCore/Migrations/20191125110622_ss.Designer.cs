...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NIS.DALCore.Context.Attachment", b =>
                {
                    ...
                    b.Property<int?>("CustomerRequestArchiveId");
                    ...
                    b.HasIndex("CustomerRequestArchiveId");
            ...
            modelBuilder.Entity("NIS.DALCore.Context.CustomerRequestArchive", b =>
                {
                    ...
                    b.HasIndex("CustomerRequestTypeId");
            ...
            modelBuilder.Entity("NIS.DALCore.Context.Attachment", b =>
                {
                    ...
                    b.HasOne("NIS.DALCore.Context.CustomerRequestArchive")
                        .WithMany("Attachment")
                        .HasForeignKey("CustomerRequestArchiveId");
            ...
            modelBuilder.Entity("NIS.DALCore.Context.MainTask", b =>
                {
                    b.HasOne("NIS.DALCore.Context.CustomerRequestArchive", "CustomerRequestArchive")
                        .WithMany("MainTask")
                        .HasForeignKey("CustomerRequestArchiveId");
