(function () {
    ...
    angular
        .module('app.core')
        .factory('sinsGenerator', sinsGeneratorService);

    /** @ngInject */
    function sinsGeneratorService($window, $log, sinsTheming) {
        ...
        function generate() {
            ...
            var registeredThemes = angular.copy(sinsTheming.getRegisteredThemes());
            var registeredPalettes = angular.copy(sinsTheming.getRegisteredPalettes());
        ...
        function processAndStoreThemes(_themes) {
            ...
            sinsTheming.setThemesList(themes);

            // Remember selected theme.
            var selectedTheme = $window.localStorage.getItem('selectedTheme');

            if (selectedTheme) {
                sinsTheming.setActiveTheme(selectedTheme);
            }
            else {
                sinsTheming.setActiveTheme('default');
            }
        }
