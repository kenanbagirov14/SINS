(function () {
    ...
    angular
        .module('app.core')
        .service('sinsTheming', sinsThemingService);

    /** @ngInject */
    function sinsThemingService($window, $log, $mdTheming) {
        var service = {
        ...
        function setActiveTheme(themeName) {
            ...
            if (angular.isUndefined(service.themes.list[themeName])) {
                ...
                $window.localStorage.setItem('selectedTheme', service.themes.active.name);
