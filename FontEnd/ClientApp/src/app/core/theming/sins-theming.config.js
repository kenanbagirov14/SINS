(function ()
{
    ...
    /** @ngInject */
    function config($mdThemingProvider, sinsPalettes, sinsThemes)
    {
        ...
        // if ( customTheme )
        // {
        //     sinsThemes['custom'] = customTheme;
        // }

        $mdThemingProvider.alwaysWatchTheme(true);

        // Define custom palettes
        angular.forEach(sinsPalettes, function (palette)
        {
            $mdThemingProvider.definePalette(palette.name, palette.options);
        });

        // Register custom themes
        angular.forEach(sinsThemes, function (theme, themeName)
        {
