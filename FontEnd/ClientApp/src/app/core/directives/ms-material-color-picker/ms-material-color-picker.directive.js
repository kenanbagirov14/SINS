(function ()
{
    ...
    /** @ngInject */
    function msMaterialColorPickerController($scope, $mdColorPalette, $mdMenu, sinsGenerator)
    {
        var vm = this;
        ...
        function updateSelectedColor(palette, hue)
        {
            vm.selectedColor = {
                ...
                bgColorValue: sinsGenerator.rgba(vm.palettes[palette][hue].value),
                fgColorValue: sinsGenerator.rgba(vm.palettes[palette][hue].contrast)
            };
