(function () {
    ...
    /** @ngInject */
    function MsShortcutsController($scope, $window, $document, $timeout, $q, msNavigationService) {
        var vm = this;
        ...
        function loadShortcuts() {
            ...
            var shortcuts = angular.fromJson($window.localStorage.getItem('SINS.shortcuts'));
            ...
            if (angular.isUndefined(shortcuts)) {
                ...
                $window.localStorage.setItem('SINS.shortcuts', angular.toJson(shortcuts));
            }
        ...
        function saveShortcuts() {
            ...
            $window.localStorage.setItem('SINS.shortcuts', angular.toJson(vm.shortcuts));
