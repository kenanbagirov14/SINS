(function ()
{
    ...
    /** @ngInject */
    function msScrollDirective($timeout, msScrollConfig, msUtils, sinsConfig)
    {
        return {
            restrict: 'AE',
            compile : function (tElement)
            {
                ...
                if ( sinsConfig.getConfig('disableCustomScrollbars') )
                {
                    return;
                }
                ...
                if ( sinsConfig.getConfig('disableCustomScrollbarsOnMobile') && msUtils.isMobile() )
                {
                    return;
                }
