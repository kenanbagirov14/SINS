(function () {
    ...
    /** @ngInject */
    function MsThemeOptionsController($window, sinsTheming) {
        var vm = this;
        ...
        vm.layoutMode = 'wide';
        vm.layoutStyle = $window.localStorage.getItem('layoutStyle') || 'verticalNavigation';
        ...
        function setActiveTheme(themeName) {
            sinsTheming.setActiveTheme(themeName);
        }
        ...
        function getActiveTheme() {
            return sinsTheming.themes.active;
        }
        ...
        function updateLayoutStyle() {
            // Update the cookie
            $window.localStorage.setItem('layoutStyle', vm.layoutStyle);
            ...
            compile: function (tElement) {
                ...
                return function postLink(scope) {
                    ...
                    function toggleOptionsSidenav() {
                        // Toggle the sins theme options panel
                        $mdSidenav('sins-theme-options').toggle();
                    }
