(function () {
    ...
    function config($translatePartialLoaderProvider, msApiProvider) {
        ...
        // Api
        msApiProvider.register('findNotification', ['NotificationUser/findall']);
        msApiProvider.register('updateNotification', ['NotificationUser/updateRange']);
        msApiProvider.register('removeNotification', ['NotificationUser/removeRange']);
